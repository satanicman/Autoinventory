...
<div class="registration-wrap">
    <div class="registration-header-wrap">
        <div id="registration-header-inner">
            {if isset($registration) && $registration}
                {if isset($registration.title) && $registration.title}
                    <h1 class="registration-header-title">{$registration.title}</h1>
                {/if}
                {if isset($registration.text) && $registration.text}
                    <p class="registration-header-text">{$registration.text}</p>
                {/if}
            {/if}
        </div>
    </div>
    <div class="clearfix registration-content" id="registration-content">
                            ...
                            <div id="opc_invoice_address" class="unvisible">
                                ...
                                {foreach from=$inv_all_fields item=field_name}
                                    ...
                                    {elseif $field_name eq "dni"}
                                        ...
                                        <div class="required form-group dni_invoice">
                                            ...
                                            <input type="text" class="text form-control" name="dni_invoice"
                                                   id="dni_invoice"
                                    ...
                                    {elseif $field_name eq "city"}
                                        <div class="required form-group">
                                            ...
                                            <input type="text" class="form-control" name="city_invoice"
                                                   id="city_invoice"
                                ...
                                {if !$postCodeExist}
                                    <div class="required postcode_invoice form-group unvisible">
                                        <label for="postcode_invoice">{l s='Zip/Postal Code'} <sup>*</sup></label>
                                        <input type="text" class="form-control" name="postcode_invoice"
                                               id="postcode_invoice"
                                               value="{if isset($smarty.post.postcode_invoice) && $smarty.post.postcode_invoice}{$smarty.post.postcode_invoice}{/if}"/>
                                    </div>
                                {/if}
        ...
        {else}
            {if isset($step) && $step}
                {if $step == 1}
                    {include file="$tpl_dir./step1.tpl" email=$email_create}
                {elseif $step == 2}
                    {include file="$tpl_dir./step2.tpl" email=$email_create}
                {/if}
            {/if}
        {/if}
    </div>
