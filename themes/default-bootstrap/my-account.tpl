...
<div class="myac-wrapper">
    <div class="dashboard col-lg-2 col-mb-12 myac-column">
        <h3 class="dashboard-title title medium">{l s="Dashboard"}</h3>
        <ul class="myac-links">
            <li class="myac-link-wrap"><a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" class="myac-link{if !isset($smarty.get.tab)} selected{/if}">{l s="Inventory"}</a></li>
            <li class="myac-link-wrap"><a href="{$link->getPageLink('my-account', true, null, 'tab=list-a-car')|escape:'html':'UTF-8'}" class="myac-link{if isset($smarty.get.tab) && $smarty.get.tab == 'list-a-car'} selected{/if}">{l s="List a car"}</a></li>
            <li class="myac-link-wrap"><a href="{$link->getPageLink('my-account', true, null, 'tab=leads')|escape:'html':'UTF-8'}" class="myac-link{if isset($smarty.get.tab) && $smarty.get.tab == 'leads'} selected{/if}">{l s="Leads"}{if isset($massage_count) && $massage_count} <span class="myac-link-num">{$massage_count}</span>{/if}</a></li>
            <li class="myac-link-wrap"><a href="{$link->getPageLink('my-account', true, null, 'tab=dealer')|escape:'html':'UTF-8'}" class="myac-link{if isset($smarty.get.tab) && $smarty.get.tab == 'dealer'} selected{/if}">{l s="Dealer"}</a></li>
        </ul>
    </div>
    <div class="myac-content col-lg-10 col -md-12 myac-column">
...
{*<div class="row addresses-lists">*}
	{*<div class="col-xs-12 col-sm-6 col-lg-4">*}
		{*<ul class="myaccount-link-list">*}
            ...
            {*<li><a href="{$link->getPageLink('address', true, null, 'test=1&test2=2')|escape:'html':'UTF-8'}" title="{l s='Add my first address'}"><i class="icon-building"></i><span>{l s='Add my first address'}</span></a></li>*}
            {*{/if}*}
