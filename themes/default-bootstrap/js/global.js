...
$(document).ready(function(){
	...
	$(document).on('hover', '.help-icon', function(){
		console.log(1);
	});
	$('.help-icon').hover(function() {
		$(this).siblings('.help-text').addClass('show');
	}, function () {
		$(this).siblings('.help-text').removeClass('show');
	});
...
{
	console.log(view);
	var base_col = 'col-lg-4 col-md-6';
	if (view == 'list')
	{
		$('ul.product_list').removeClass('grid').addClass('list row');
		$('.product_list > li').removeClass(base_col).addClass('col-xs-12');
	...
	else
	{
		...
		$('.product_list > li').removeClass('col-xs-12').addClass(base_col);
		$('.display').find('li#grid').addClass('selected');
