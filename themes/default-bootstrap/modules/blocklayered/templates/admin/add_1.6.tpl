					...
					<section class="filter_list">
						<ul class="list-unstyled sortable">
							...
							<li class="filter_list_item" draggable="true">
								<div class="col-lg-2">
									<label class="switch-light prestashop-switch fixed-width-lg">
										<input name="layered_selection_year_slider" id="layered_selection_year_slider" type="checkbox" />
										<span>
											<span>{l s='Yes' mod='blocklayered'}</span>
											<span>{l s='No' mod='blocklayered'}</span>
										</span>
								...
								<div class="col-lg-4">
									<span class="module_name">{l s='Product year filter (slider)' mod='blocklayered'}</span>
								</div>
								<div class="col-lg-3 pull-right">
									<label class="control-label col-lg-6">{l s='Filter result limit:' mod='blocklayered'}</label>
									<div class="col-lg-6">
										<select name="layered_selection_year_slider_filter_show_limit">
											<option value="0">{l s='No limit' mod='blocklayered'}</option>
											<option value="4">4</option>
											<option value="5">5</option>
											<option value="10">10</option>
								...
								<div class="col-lg-3 pull-right">
									<label class="control-label col-lg-6">{l s='Filter style:' mod='blocklayered'}</label>
									<div class="col-lg-6">
										<select name="layered_selection_year_slider_filter_type">
											<option value="0">{l s='Slider' mod='blocklayered'}</option>
											<option value="1">{l s='Inputs area' mod='blocklayered'}</option>
											<option value="2">{l s='List of values' mod='blocklayered'}</option>
										</select>
							...
							<li class="filter_list_item" draggable="true">
								<div class="col-lg-2">
									<label class="switch-light prestashop-switch fixed-width-lg">
										<input name="layered_selection_miles_slider" id="layered_selection_miles_slider" type="checkbox" />
										<span>
											<span>{l s='Yes' mod='blocklayered'}</span>
											<span>{l s='No' mod='blocklayered'}</span>
										</span>
								...
								<div class="col-lg-4">
									<span class="module_name">{l s='Product miles filter (slider)' mod='blocklayered'}</span>
								</div>
								<div class="col-lg-3 pull-right">
									<label class="control-label col-lg-6">{l s='Filter result limit:' mod='blocklayered'}</label>
									<div class="col-lg-6">
										<select name="layered_selection_miles_slider_filter_show_limit">
											<option value="0">{l s='No limit' mod='blocklayered'}</option>
											<option value="4">4</option>
											<option value="5">5</option>
											<option value="10">10</option>
								...
								<div class="col-lg-3 pull-right">
									<label class="control-label col-lg-6">{l s='Filter style:' mod='blocklayered'}</label>
									<div class="col-lg-6">
										<select name="layered_selection_miles_slider_filter_type">
											<option value="0">{l s='Slider' mod='blocklayered'}</option>
											<option value="1">{l s='Inputs area' mod='blocklayered'}</option>
											<option value="2">{l s='List of values' mod='blocklayered'}</option>
										</select>
