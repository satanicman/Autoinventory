...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="year">
			<span>
				{$bullet_common_field} {l s='Year'}
			</span>
		</label>
		<div class="col-lg-5">
			<input type="text" id="year" name="year" value="{$product->year|htmlentitiesUTF8}" />
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3" for="miles">
			<span>
				{$bullet_common_field} {l s='Miles'}
			</span>
		</label>
		<div class="col-lg-5">
			<input type="text" id="miles" name="miles" value="{$product->miles|htmlentitiesUTF8}" />
		</div>
	</div>
