...
class Feature extends FeatureCore
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'is_feature'    =>      array('type' => self::TYPE_INT, 'validate' => 'isInt'),
    ...
    public static function getFeatureFeatures($id_lang, $with_shop = true)
    {
        return Db::getInstance()->executeS('
		SELECT DISTINCT f.id_feature, f.*, fl.*
		FROM `'._DB_PREFIX_.'feature` f
    ...
    public static function getFieldFeatures($id_lang, $with_shop = true)
    {
        return Db::getInstance()->executeS('
		SELECT DISTINCT f.id_feature, f.*, fl.*
		FROM `'._DB_PREFIX_.'feature` f
