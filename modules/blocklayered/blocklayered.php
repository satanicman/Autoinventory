...
class BlockLayered extends Module
{
	...
	public function hookFilterTop($params)
    {
			...
			switch ($filter['type'])
			{
				...
				case 'id_feature':
					...
					if (isset($products) && $products)
					{
						...
						{
//							$sql = "SELECT id_feature,is_slider,filter_position FROM "._DB_PREFIX_."feature WHERE id_feature = ".$feature['id_feature'];
...
////		echo '<pre>';
////		print_r($filter_blocks);
////		echo '</pre>';
//		echo '<pre>';
//		print_r($filter_blocks_top);
//		echo '</pre>';
//		die();
