...
class BlockCms extends Module
{
	...
	public function install()
	{
		if (!parent::install()
			...
			|| !Configuration::updateValue('FOOTER_HOME', 1)
		)
		return false;
	...
	public function uninstall()
	{
		...
		if (!parent::uninstall() ||
			...
			!Configuration::deleteByName('FOOTER_HOME')
		)
			return false;
		return true;
	}
	...
	protected function displayForm()
	{
		...
		$this->fields_form[1]['form'] = array(
			...
			'input' => array(
				...
				array(
					'type' => 'checkbox',
					'name' => 'cms_footer_home',
					'values' => array(
						'query' => array(
							array(
								'id' => 'on',
								'name' => $this->l('Display "Home" in the footer'),
								'val' => '1'
							),
						),
						'id' => 'id',
		...
		$this->fields_value['cms_footer_home_on'] = Configuration::get('FOOTER_HOME');
	...
	protected function _postProcess()
	{
		...
		elseif (Tools::isSubmit('submitFooterCMS'))
		{
			...
			Configuration::updateValue('FOOTER_HOME', (int)Tools::getValue('cms_footer_home_on'));
	...
	public function hookFooter()
	{
		...
		if (!$this->isCached('blockcms.tpl', $this->getCacheId(BlockCMSModel::FOOTER)))
		{
			...
			if(Configuration::get('FOOTER_HOME')) {
				array_unshift($cmslinks, array("link" => $shop->getBaseURI(), "meta_title" => "Home"));
			}
			$this->smarty->assign(
				array(
					'block' => 0,
